...
const EmailSection = () => {
    ...
    return (
        <section id="contacts" className="grid md:grid-cols-2 items-center justify-center py-14 md:py-20">
            <motion.div animate={controls} ref={sectionRef}>
                <h5 className="lg:text-6xl text-4xl font-bold text-white my-2">
                    Let&apos;s Connect
                </h5>
                <p className="text-slate-300 mb-4 max-w-md text-xl">
            ...
            <motion.div className="bg-primary-800 p-8 rounded-lg">
