...
const timelineData = [
    ...
    {
        id: 7,
        location: "Koperasi Permodalan Kelantan Berhad, Kota Bharu",
        endDate: "Mac 2026 - Present",
        course: "IT Officer",
        achieveList: [
        ]
    }
...
const TimelineSection = () => {
    ...
    return (
        <section className='text-white py-3 lg:py-10'>
            <motion.div animate={controls} ref={sectionRef}>
                <h2 className='text-3xl font-bold text-white mb-8 md:text-5xl text-center'>
